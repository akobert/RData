...
#	h4_pt = TH1F("h4_pt", "Photon pT", 30, widebins)
		
	h4_175 = TH1F("h4_175", "Photon pT (cutBased)", 30, widebins)
	h4_notrig = TH1F("h4_notrig", "Photon pT (cutBased)", 30, widebins)
        h4_notrig_thin = TH1F("h4_notrig_thin", "Photon pT (cutBased)", 500, 0, 500)
	
	h4_175_mva80 = TH1F("h4_175_mva80", "Photon pT (WP80)", 30, widebins)
	h4_notrig_mva80 = TH1F("h4_notrig_mva80", "Photon pT (WP80)", 30, widebins)
        h4_notrig_thin_mva80 = TH1F("h4_notrig_thin_mva80", "Photon pT (WP80)", 500, 0, 500)
	
	h4_175_mva90 = TH1F("h4_175_mva90", "Photon pT (WP90)", 30, widebins)
	h4_notrig_mva90 = TH1F("h4_notrig_mva90", "Photon pT (WP90)", 30, widebins)
        h4_notrig_thin_mva90 = TH1F("h4_notrig_thin_mva90", "Photon pT (WP90)", 500, 0, 500)
	
	h4_175_mva8 = TH1F("h4_175_mva8", "Photon pT (MVA >= 0.8)", 30, widebins)
	h4_notrig_mva8 = TH1F("h4_notrig_mva8", "Photon pT (MVA >= 0.8)", 30, widebins)
        h4_notrig_thin_mva8 = TH1F("h4_notrig_thin_mva8", "Photon pT (MVA >= 0.8)", 500, 0, 500)
	
	h4_175_mva85 = TH1F("h4_175_mva85", "Photon pT (MVA >= 0.85)", 30, widebins)
	h4_notrig_mva85 = TH1F("h4_notrig_mva85", "Photon pT (MVA >= 0.85)", 30, widebins)
        h4_notrig_thin_mva85 = TH1F("h4_notrig_thin_mva85", "Photon pT (MVA >= 0.85)", 500, 0, 500)
	
	h4_175_mva9 = TH1F("h4_175_mva9", "Photon pT (MVA >= 0.9)", 30, widebins)
	h4_notrig_mva9 = TH1F("h4_notrig_mva9", "Photon pT (MVA >= 0.9)", 30, widebins)
	...
	h5_175 = TH2F("h5_175_pt_eta", "Jet Eta vs. Jet pT Photon175 (CutBased ID)", 30, -1.5, 1.5, 20, 150, 250)

	h5_notrig.SetXTitle("Photon Eta")
	h5_notrig.SetYTitle("Photon pT")
	h5_175.SetXTitle("Photon Eta")
	h5_175.SetYTitle("Photon pT")
	...
	for F in sample:
		...
		Rdf_175 = Rdf_notrig.Filter("HLT_Photon175 > 0")
                cut_175 = int(Rdf_175.Count())
		print(str(cut_175)+" Events passing 175 trig (cutBased) in Sample")
		
		Rdf_175_mva80 = Rdf_notrig_mva80.Filter("HLT_Photon175 > 0")
                cut_175_mva80 = int(Rdf_175_mva80.Count())
		print(str(cut_175)+" Events passing 175 trig (WP80) in Sample")
		
		Rdf_175_mva90 = Rdf_notrig_mva90.Filter("HLT_Photon175 > 0")
                cut_175_mva90 = int(Rdf_175_mva90.Count())
		print(str(cut_175)+" Events passing 175 trig (WP90) in Sample")
		
		Rdf_175_mva8 = Rdf_notrig_mva8.Filter("HLT_Photon175 > 0")
                cut_175_mva8 = int(Rdf_175_mva8.Count())
		print(str(cut_175)+" Events passing 175 trig (MVA >= 0.8) in Sample")
		
		Rdf_175_mva85 = Rdf_notrig_mva85.Filter("HLT_Photon175 > 0")
                cut_175_mva85 = int(Rdf_175_mva85.Count())
		print(str(cut_175)+" Events passing 175 trig (MVA >= 0.85) in Sample")
		
		Rdf_175_mva9 = Rdf_notrig_mva9.Filter("HLT_Photon175 > 0")
                cut_175_mva9 = int(Rdf_175_mva9.Count())
		print(str(cut_175)+" Events passing 175 trig (MVA >= 0.9) in Sample")
		
		
		t4_175 = Rdf_175.Histo1D(("t4_175", "Photon pT", 30, widebins), "pPt", "weight")
		t4_175 = t4_175.Clone()
		t4_175.SetTitle("Photon pT")
		t4_175.SetXTitle("Photon pT")
		h4_175.Add(t4_175)
		
		t4_notrig = Rdf_notrig.Histo1D(("t4_notrig", "Photon pT", 30, widebins), "pPt", "weight")
		...
		t5_175 = Rdf_175.Histo2D(("t5_175", "Photon Eta vs. Photon pT", 30, -1.5, 1.5, 20, 150, 250), "pEta", "pPt", "weight")
		t5_175 = t5_175.Clone()
		t5_175.SetXTitle("Photon Eta")
		t5_175.SetYTitle("Photon pT")
		h5_175.Add(t5_175)
		...
		t4_175_mva80 = Rdf_175_mva80.Histo1D(("t4_175_mva80", "Photon pT", 30, widebins), "pPt", "weight")
		t4_175_mva80 = t4_175_mva80.Clone()
		t4_175_mva80.SetTitle("Photon pT")
		t4_175_mva80.SetXTitle("Photon pT")
		h4_175_mva80.Add(t4_175_mva80)
		
		t4_notrig_mva80 = Rdf_notrig_mva80.Histo1D(("t4_notrig_mva80", "Photon pT", 30, widebins), "pPt", "weight")
		...
		t4_175_mva90 = Rdf_175_mva90.Histo1D(("t4_175_mva90", "Photon pT", 30, widebins), "pPt", "weight")
		t4_175_mva90 = t4_175_mva90.Clone()
		t4_175_mva90.SetTitle("Photon pT")
		t4_175_mva90.SetXTitle("Photon pT")
		h4_175_mva90.Add(t4_175_mva90)
		
		t4_notrig_mva90 = Rdf_notrig_mva90.Histo1D(("t4_notrig_mva90", "Photon pT", 30, widebins), "pPt", "weight")
		...
		t4_175_mva8 = Rdf_175_mva8.Histo1D(("t4_175_mva8", "Photon pT", 30, widebins), "pPt", "weight")
		t4_175_mva8 = t4_175_mva8.Clone()
		t4_175_mva8.SetTitle("Photon pT")
		t4_175_mva8.SetXTitle("Photon pT")
		h4_175_mva8.Add(t4_175_mva8)
		
		t4_notrig_mva8 = Rdf_notrig_mva8.Histo1D(("t4_notrig_mva8", "Photon pT", 30, widebins), "pPt", "weight")
		...
		t4_175_mva85 = Rdf_175_mva85.Histo1D(("t4_175_mva85", "Photon pT", 30, widebins), "pPt", "weight")
		t4_175_mva85 = t4_175_mva85.Clone()
		t4_175_mva85.SetTitle("Photon pT")
		t4_175_mva85.SetXTitle("Photon pT")
		h4_175_mva85.Add(t4_175_mva85)
		
		t4_notrig_mva85 = Rdf_notrig_mva85.Histo1D(("t4_notrig_mva85", "Photon pT", 30, widebins), "pPt", "weight")
		...
		t4_175_mva9 = Rdf_175_mva9.Histo1D(("t4_175_mva9", "Photon pT", 30, widebins), "pPt", "weight")
		t4_175_mva9 = t4_175_mva9.Clone()
		t4_175_mva9.SetTitle("Photon pT")
		t4_175_mva9.SetXTitle("Photon pT")
		h4_175_mva9.Add(t4_175_mva9)
		
		t4_notrig_mva9 = Rdf_notrig_mva9.Histo1D(("t4_notrig_mva9", "Photon pT", 30, widebins), "pPt", "weight")
	...
	ofile.WriteObject(h4_175_mva90, "photon_pt_175_mva90")
	...
	ofile.WriteObject(h4_175_mva9, "photon_pt_175_mva9")

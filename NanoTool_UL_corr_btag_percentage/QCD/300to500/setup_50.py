...
if __name__ == "__main__":
    ...
    for process in range(1280):
        ...
        newFile = open("QCD300to500_" + str(process) + "_50.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(59.9 * 323400000.0/57424788.0), 1, \"QCD\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"QCD300to500_UL_nano_"+str(process)+"_50\""

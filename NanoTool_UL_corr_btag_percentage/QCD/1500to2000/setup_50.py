...
if __name__ == "__main__":
    ...
    for process in range(526):
        ...
        newFile = open("QCD1500to2000_" + str(process) + "_50.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(59.9 * 997600.0/12065700.0), 1, \"QCD\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"QCD1500to2000_UL_nano_"+str(process)+"_50\""

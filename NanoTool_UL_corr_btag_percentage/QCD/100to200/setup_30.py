...
if __name__ == "__main__":
    ...
    for process in range(1659):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag_percentage/nano_Sample_30.py", "r")
        newFile = open("QCD100to200_" + str(process) + "_30.py", "a+")
	...
	newline2 = "fname = \"QCD100to200_UL_nano_"+str(process)+"_30\""

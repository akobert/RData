...
if __name__ == "__main__":
    ...
    for process in range(1659):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag_percentage/nano_Sample_50.py", "r")
        newFile = open("QCD100to200_" + str(process) + "_50.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(59.9 * 23590000000.0/81790035.0), 1, \"QCD\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"QCD100to200_UL_nano_"+str(process)+"_50\""

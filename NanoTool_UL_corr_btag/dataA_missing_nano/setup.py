...
if __name__ == "__main__":
    ...
    for process in range(2102):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag/nano_Sample.py", "r")
        newFile = open("dataA_missing_" + str(process) + ".py", "a+")
	...
	newline2 = "fname = \"DataA_missing_UL_nano_"+str(process)+"\""

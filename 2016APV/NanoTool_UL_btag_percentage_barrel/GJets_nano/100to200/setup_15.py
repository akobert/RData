...
if __name__ == "__main__":
    ...
    for process in range(43):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/2016APV/NanoTool_UL_btag_percentage_barrel/nano_Sample_15.py", "r")
        newFile = open("GJ100to200_" + str(process) + "_15.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(19.5 * 9238000.0/9332192.0), 1, \"GJ\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"GJ100to200_UL_nano_"+str(process)+"_15\""

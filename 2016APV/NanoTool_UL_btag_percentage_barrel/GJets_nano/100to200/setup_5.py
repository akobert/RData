...
if __name__ == "__main__":
    ...
    for process in range(43):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/2016APV/NanoTool_UL_btag_percentage_barrel/nano_Sample_5.py", "r")
        newFile = open("GJ100to200_" + str(process) + "_5.py", "a+")
	...
	newline2 = "fname = \"GJ100to200_UL_nano_"+str(process)+"_5\""

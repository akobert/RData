...
if __name__ == "__main__":
    ...
    for process in range(521):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag_percentage_barrel/nano_Sample_50.py", "r")
        newFile = open("QCD1000to1500_" + str(process) + "_50.py", "a+")
	...
	newline2 = "fname = \"QCD1000to1500_UL_nano_"+str(process)+"_50\""

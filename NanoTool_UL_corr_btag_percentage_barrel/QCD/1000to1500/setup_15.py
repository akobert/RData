...
if __name__ == "__main__":
    ...
    for process in range(521):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag_percentage_barrel/nano_Sample_15.py", "r")
        newFile = open("QCD1000to1500_" + str(process) + "_15.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(59.82 * 1207000.0/15243172.0), 1, \"QCD\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"QCD1000to1500_UL_nano_"+str(process)+"_15\""

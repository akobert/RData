...
if __name__ == "__main__":
	...
	files = [["/cms/xaastorage/NanoAOD/2018/JUNE19/VectorZPrimeGammaToQQGamma_M20_temp/", str(59.9 * 26930.0/453231.0)]]
	...
	ROOT.gInterpreter.ProcessLine("auto cutoff = "+str(cut_ID)+";")
        ...
        ddt_code =      '''
                        ...
                        '''
        region_code = "float a=100; float b=300; float c=15; float d=30;"
	...
	percentage = 20
	fname = "20GeV_20"
	SamplePro(files, fname, cut_hist, percentage, 100, 300, 15, 30)	
	
	

	print("20 GeV Finished")

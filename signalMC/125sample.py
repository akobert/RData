...
if __name__ == "__main__":
	...
	files = [["/cms/xaastorage/NanoAOD/2018/JUNE19/VectorZPrimeGammaToQQGamma_M125_temp/", str(59.9 * 1853.0/471034.0)]]
	...
	ROOT.gInterpreter.ProcessLine("auto cutoff = "+str(cut_ID)+";")
        ...
        ddt_code =      '''
                        ...
                        '''
        region_code = "float a=100; float b=300; float c=120; float d=135;"
	...
	percentage = 20
	fname = "125GeV_20"
	SamplePro(files, fname, cut_hist, percentage, 100, 300, 120, 135)	
	
	

	print("125 GeV Finished")

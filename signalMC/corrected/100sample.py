...
if __name__ == "__main__":
	...
	ROOT.gInterpreter.ProcessLine("auto cutoff = "+str(cut_ID)+";")
        ...
        ddt_code =      '''
                        ...
                        '''
        region_code = "float a=100; float b=300; float c=95; float d=110;"
	...
	percentage = 20
	fname = "100GeV_20_corr"
	SamplePro(files, fname, cut_hist, percentage, 100, 300, 95, 110)	
	
	

	print("100 GeV Finished")

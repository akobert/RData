...
if __name__ == "__main__":
    ...
    for process in range(17):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/2016/NanoTool_UL_btag_percentage_barrel/nano_Sample_5.py", "r")
        newFile = open("GJ200to400_" + str(process) + "_5.py", "a+")
	...
	newline2 = "fname = \"GJ200to400_UL_nano_"+str(process)+"_5\""

...
if __name__ == "__main__":
    ...
    for process in range(17):
        ...
        newFile = open("GJ200to400_" + str(process) + "_25.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(16.81 * 2305000.0/19881850.0), 1, \"GJ\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"GJ200to400_UL_nano_"+str(process)+"_25\""

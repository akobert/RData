...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, o):
		...
		LUMI = 1.68 #Temporary luminosity with 10% of 2018 data
		...
		c1.cd()
		c1.SetLogy()
		self.h1.SetTitle("2016 ParticleNetMD Xqq/(Xqq+QCD) Score")
		...
		c1.SaveAs("./plots/Xqq_QCD_2016.png")
		c1.Close()
		
		c2 = TCanvas()
		c2.cd()
		c2.SetLogy()
		self.h1_all.SetTitle("2016 ParticleNetMD (Xqq+Xcc+Xbb)/(Xqq+Xcc+Xbb+QCD) Score")
		...
		l2.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		c2.SaveAs("./plots/Xqq_ALLQQ_2016.png")
		c2.Close()

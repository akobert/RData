...
class drawRData:
	def __init__(self, name, sfile1, sfile2, sfile3, sfile4, sfile5, sfile6, o):
		...
		ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_draw/SRootB_2016/Xqq/"+o,"RECREATE")
		...
		self.M25_all.GetYaxis().SetRangeUser(0, 20)
		...
		c5 = TCanvas()
		c5.cd()
		self.M25.SetTitle("2016 S/Root(B) vs. Xqq/(Xqq+QCD) Score Cut")
		self.M25.Draw("ALP*")
		self.M10.Draw("LP*")
		self.M50.Draw("LP*")
		self.M75.Draw("LP*")
		...
		self.ZG.Draw("LP*")
                ...
                l1.Draw()
                gPad.Update()
		c5.SaveAs("./plots/SRootB_barrel_Xqq_2016.png")
		c5.Close()
		
		c6 = TCanvas()
		c6.cd()
		self.M25_all.SetTitle("2016 S/Root(B) vs. (Xqq+Xcc+Xbb)/(Xqq+Xcc+Xbb+QCD) Score Cut")
		...
		self.ZG_all.Draw("LP*")
                ...
                l1.Draw()
                gPad.Update()
		c6.SaveAs("./plots/SRootB_barrel_XqqALL_2016.png")
		c6.Close()

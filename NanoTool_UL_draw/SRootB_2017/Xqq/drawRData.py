...
#		print("SALL75: "+str(SALL75)+" BALL75: "+str(BALL75))
		...
		lin2.Draw()
                ...
                gPad.Update()
		c80.SaveAs("./plots/SRootB_2017_"+name+"_80_Xqq.png")
		c80.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c85.SaveAs("./plots/SRootB_2017_"+name+"_85_Xqq.png")
		c85.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c90.SaveAs("./plots/SRootB_2017_"+name+"_90_Xqq.png")
		c90.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c91.SaveAs("./plots/SRootB_2017_"+name+"_91_Xqq.png")
		c91.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c92.SaveAs("./plots/SRootB_2017_"+name+"_92_Xqq.png")
		c92.Close()	
		...
		lin2.Draw()
                ...
                gPad.Update()
		c93.SaveAs("./plots/SRootB_2017_"+name+"_93_Xqq.png")
		c93.Close()	
		...
		lin2.Draw()
                ...
                gPad.Update()
		c94.SaveAs("./plots/SRootB_2017_"+name+"_94_Xqq.png")
		c94.Close()	
		...
		lin2.Draw()
                ...
                gPad.Update()
		c95.SaveAs("./plots/SRootB_2017_"+name+"_95_Xqq.png")
		c95.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c96.SaveAs("./plots/SRootB_2017_"+name+"_96_Xqq.png")
		c96.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c97.SaveAs("./plots/SRootB_2017_"+name+"_97_Xqq.png")
		c97.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c98.SaveAs("./plots/SRootB_2017_"+name+"_98_Xqq.png")
		c98.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c99.SaveAs("./plots/SRootB_2017_"+name+"_99_Xqq.png")
		c99.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B80))
                gPad.Update()
		c_all_80.SaveAs("./plots/SRootB_2017_"+name+"_80_AllQQ.png")
		c_all_80.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B85))
                gPad.Update()
		c_all_85.SaveAs("./plots/SRootB_2017_"+name+"_85_AllQQ.png")
		c_all_85.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B90))
                gPad.Update()
		c_all_90.SaveAs("./plots/SRootB_2017_"+name+"_90_AllQQ.png")
		c_all_90.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B91))
                gPad.Update()
		c_all_91.SaveAs("./plots/SRootB_2017_"+name+"_91_AllQQ.png")
		c_all_91.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B92))
                gPad.Update()
		c_all_92.SaveAs("./plots/SRootB_2017_"+name+"_92_AllQQ.png")
		c_all_92.Close()	
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B93))
                gPad.Update()
		c_all_93.SaveAs("./plots/SRootB_2017_"+name+"_93_AllQQ.png")
		c_all_93.Close()	
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B94))
                gPad.Update()
		c_all_94.SaveAs("./plots/SRootB_2017_"+name+"_94_AllQQ.png")
		c_all_94.Close()	
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B95))
                gPad.Update()
		c_all_95.SaveAs("./plots/SRootB_2017_"+name+"_95_AllQQ.png")
		c_all_95.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B96))
                gPad.Update()
		c_all_96.SaveAs("./plots/SRootB_2017_"+name+"_96_AllQQ.png")
		c_all_96.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B97))
                gPad.Update()
		c_all_97.SaveAs("./plots/SRootB_2017_"+name+"_97_AllQQ.png")
		c_all_97.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B98))
                gPad.Update()
		c_all_98.SaveAs("./plots/SRootB_2017_"+name+"_98_AllQQ.png")
		c_all_98.Close()
		...
		lin2.Draw()
                ...
                t1.DrawTextNDC(.4, .45, "B = "+str(B99))
                gPad.Update()
		c_all_99.SaveAs("./plots/SRootB_2017_"+name+"_99_AllQQ.png")
		c_all_99.Close()
...
#		self.SRB.SetPoint(14,.75,SRB75)
		...
		c_srb.SaveAs("./plots/SRB_2017_"+name+"_Xqq.png")
		c_srb.Close()
...
#		self.SRBALL.SetPoint(14,.75,SRBALL75)
		...
		c_srball.SaveAs("./plots/SRBALL_2017_"+name+"_Xqq.png")
		c_srball.Close()

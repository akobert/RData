...
#		c1.SetLogy()
		...
		l1.SetLineColor(0)
                ...
                l1.AddEntry(self.h1_TTBar, "TTBar")
                l1.Draw()
...
#		c1_p.SetLogy()
		...
		l1_p.SetLineColor(0)
                ...
                l1_p.AddEntry(self.p1_TTBar, "TTBar")
                l1_p.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
...
#		c2.SetLogy()
		...
		l2.SetLineColor(0)
                ...
                l2.AddEntry(self.h2_TTBar, "TTBar")
                l2.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
...
#		c2_p.SetLogy()
		...
		l2_p.SetLineColor(0)
                ...
                l2_p.AddEntry(self.p2_TTBar, "TTBar")
                l2_p.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
...
#		c2_1_Data.SetLogy()
		self.h2_Data.SetTitle("Softdrop Mass")
		self.h2_Data.Draw("hist")
		self.h2_1_Data.Draw("same hist")
		l2_1_Data = TLegend(.53, .68, .89, .89)
		l2_1_Data.SetFillColor(0)
		l2_1_Data.SetLineColor(0)
                l2_1_Data.AddEntry(self.h2_Data, "SingleMuon 2017 Data Corrected")
                l2_1_Data.AddEntry(self.h2_1_Data, "SingleMuon 2017 Data Uncorrected")
                l2_1_Data.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
		wmass.SetLineWidth(2)
		wmass.Draw("same")
		c2_1_Data.SaveAs("./plots/"+name+"_thin_soft_Data.png")
#		c2_1_Data.SaveAs("./plots/"+name+"_thin_soft_Data.root")
		c2_1_Data.Close()
...
#		c2_1_TTBar.SetLogy()
		...
		l2_1_TTBar.SetLineColor(0)
                l2_1_TTBar.AddEntry(self.h2_TTBar, "TTBar Corrected")
                l2_1_TTBar.AddEntry(self.h2_1_TTBar, "TTBar Uncorrected")
                l2_1_TTBar.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
...
#		c2_1_p_Data.SetLogy()
		self.p2_Data.SetTitle("Passing Softdrop Mass")
		self.p2_Data.Draw("hist")
		self.p2_1_Data.Draw("same hist")
		l2_1_p_Data = TLegend(.53, .68, .89, .89)
		l2_1_p_Data.SetFillColor(0)
		l2_1_p_Data.SetLineColor(0)
                l2_1_p_Data.AddEntry(self.p2_Data, "SingleMuon 2017 Data Corrected")
                l2_1_p_Data.AddEntry(self.p2_1_Data, "SingleMuon 2017 Data Uncorrected")
                l2_1_p_Data.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
		wmass.SetLineWidth(2)
		wmass.Draw("same")
		c2_1_p_Data.SaveAs("./plots/"+name+"_thin_pass_soft_Data.png")
#		c2_1_p_Data.SaveAs("./plots/"+name+"_thin_pass_soft_Data.root")
		c2_1_p_Data.Close()
...
#		c2_1_p_TTBar.SetLogy()
		...
		l2_1_p_TTBar.SetLineColor(0)
                l2_1_p_TTBar.AddEntry(self.p2_TTBar, "TTBar Corrected")
                l2_1_p_TTBar.AddEntry(self.p2_1_TTBar, "TTBar Uncorrected")
                l2_1_p_TTBar.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		wmass = TLine(80.379,0,80.379,gPad.GetUymax())
		wmass.SetLineColor(kViolet)
...
#		c8.SetLogy()
		...
		l8.SetLineColor(0)
                ...
                l8.AddEntry(self.h8_TTBar, "TTBar")
                l8.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
...
#		c9.SetLogy()
		...
		l9.SetLineColor(0)
                ...
                l9.AddEntry(self.h9_TTBar, "TTBar")
                l9.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)

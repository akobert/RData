...
class drawRData:
	def __init__(self, name, sfile1, sfile2, sfile3, sfile4, sfile5, sfile6, sfile7, sfile8, o):
		...
		ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_draw/correction_check_2016/"+o,"RECREATE")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c10.SaveAs("./plots/corr_comp_10GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c20.SaveAs("./plots/corr_comp_20GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c25.SaveAs("./plots/corr_comp_25GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c50.SaveAs("./plots/corr_comp_50GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c75.SaveAs("./plots/corr_comp_75GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c100.SaveAs("./plots/corr_comp_100GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c125.SaveAs("./plots/corr_comp_125GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c150.SaveAs("./plots/corr_comp_150GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c10.SaveAs("./plots/corr_comp_pass_10GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c20.SaveAs("./plots/corr_comp_pass_20GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c25.SaveAs("./plots/corr_comp_pass_25GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c50.SaveAs("./plots/corr_comp_pass_50GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c75.SaveAs("./plots/corr_comp_pass_75GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c100.SaveAs("./plots/corr_comp_pass_100GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c125.SaveAs("./plots/corr_comp_pass_125GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c150.SaveAs("./plots/corr_comp_pass_150GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c10.SaveAs("./plots/corr_comp_fail_10GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c20.SaveAs("./plots/corr_comp_fail_20GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c25.SaveAs("./plots/corr_comp_fail_25GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c50.SaveAs("./plots/corr_comp_fail_50GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c75.SaveAs("./plots/corr_comp_fail_75GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c100.SaveAs("./plots/corr_comp_fail_100GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c125.SaveAs("./plots/corr_comp_fail_125GeV_2016.png")
...
#                gPad.SetLogy()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c150.SaveAs("./plots/corr_comp_fail_150GeV_2016.png")
		...
		self.corr_sig = TH1F("corr_sig", "2016 Summary Plot Correction Comparison", 100, 0, 200)
		self.uncorr_sig = TH1F("uncorr_sig", "2016 Summary Plot (un)Correction Comparison", 100, 0, 200)
		self.corr_sig_pass = TH1F("corr_sig_pass", "2016 Passing Summary Plot Correction Comparison", 100, 0, 200)
		self.uncorr_sig_pass = TH1F("uncorr_sig_pass", "2016 Passing Summary Plot (un)Correction Comparison", 100, 0, 200)
		self.corr_sig_fail = TH1F("corr_sig_fail", "2016 Failing Summary Plot Correction Comparison", 100, 0, 200)
		self.uncorr_sig_fail = TH1F("uncorr_sig_fail", "2016 Failing Summary Plot (un)Correction Comparison", 100, 0, 200)
...
#		'''
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c_sum.SaveAs("./plots/corr_comp_summary_2016_addition.png")
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c_sum_pass.SaveAs("./plots/corr_comp_pass_summary_2016_addition.png")
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
                gPad.Update()
		c_sum_fail.SaveAs("./plots/corr_comp_fail_summary_2016_addition.png")
		...
		c_sum.cd()
                gPad.SetLogy()
		self.corr_sig.SetTitle("2016 Summary Plot Correction Comparison")
		...
		c_sum_pass.cd()
                gPad.SetLogy()
		self.corr_sig_pass.SetTitle("2016 Passing Summary Plot Correction Comparison")
		...
		c_sum_fail.cd()
                gPad.SetLogy()
		self.corr_sig_fail.SetTitle("2016 Failing Summary Plot Correction Comparison")

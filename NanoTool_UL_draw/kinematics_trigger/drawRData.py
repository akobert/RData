...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, ifile8, ifile9, o):
		...
		GoodPlotFormat(self.h1_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h2_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h2_1_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h3_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h4_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h5_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h6_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h7_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h8_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.h9_GJ, 'fill', 9, 1001)
		
		GoodPlotFormat(self.h1_GJ_presel, 'fill', 9, 1001)
		GoodPlotFormat(self.h2_GJ_presel, 'fill', 9, 1001)
		GoodPlotFormat(self.h2_1_GJ_presel, 'fill', 9, 1001)
		GoodPlotFormat(self.h3_GJ_presel, 'fill', 9, 1001)
		GoodPlotFormat(self.h4_GJ_presel, 'fill', 9, 1001)
		GoodPlotFormat(self.h5_GJ_presel, 'fill', 9, 1001)
		
		GoodPlotFormat(self.p1_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.p1_1_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.p2_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.p3_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.p4_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.p5_GJ, 'fill', 9, 1001)
		
		GoodPlotFormat(self.f1_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.f1_1_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.f2_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.f3_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.f4_GJ, 'fill', 9, 1001)
		GoodPlotFormat(self.f5_GJ, 'fill', 9, 1001)
		...
		self.h6_tot = TH1F("n2_tot", "Total Background N2", 100, 0, 1)
...
#		gPad.SetLogy()
		...
		c2_p.cd()
		c2_p.SetLogy()
		p22 = TPad("pad1", "tall", 0,0.175,1,1)
		p22.SetLogy()
		p22 = TPad("pad2", "short", 0,0.01,1.0,0.23)
		p22.Draw()
		p22.Draw()
...
#		gPad.SetLogy()
		...
		c3_p.cd()
		c3_p.SetLogy()
		p32 = TPad("pad1", "tall", 0,0.175,1,1)
		p32.SetLogy()
		p32 = TPad("pad2", "short", 0,0.01,1.0,0.23)
		p32.Draw()
		p32.Draw()
		p32.cd() #top
		self.p3_tot.SetTitle("Passing Jet pT")

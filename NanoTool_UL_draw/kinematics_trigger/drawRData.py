...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, ifile8, ifile9, o):
		...
		self.h3_tot = TH1F("jet_eta_tot", "Total Background Jet Eta", 50, -2.5, 2.5)
		self.h4_tot = TH1F("pho_pt_tot", "Total Background Photon pT", 50, 0, 1000)
		...
		self.h3_tot_presel = TH1F("jet_eta_tot_presel", "Total Pre-Selection Background Jet Eta", 50, -2.5, 2.5)
		...
		self.p3_tot = TH1F("pass_jet_eta_tot", "Total Passing Background Jet Eta", 50, -2.5, 2.5)
		self.p4_tot = TH1F("pass_pho_pt_tot", "Total Passing Background Photon pT", 40, 0, 1000)
		...
		self.f3_tot = TH1F("fail_jet_eta_tot", "Total Failing Background Jet Eta", 50, -2.5, 2.5)
		self.f4_tot = TH1F("fail_pho_pt_tot", "Total Failing Background Photon pT", 40, 0, 1000)
		...
		FindAndSetMax(self.h1_sig10, self.h1_sig25, self.h1_sig50, self.h1_sig75, self.h1_WG, self.h1_ZG, self.h1_GJ, self.h1_TT, self.h1_Data, self.h1_tot)
		FindAndSetMax(self.h2_sig10, self.h2_sig25, self.h2_sig50, self.h2_sig75, self.h2_WG, self.h2_ZG, self.h2_GJ, self.h2_TT, self.h2_Data, self.h2_tot)
		FindAndSetMax(self.h2_1_sig10, self.h2_1_sig25, self.h2_1_sig50, self.h2_1_sig75, self.h2_1_WG, self.h2_1_ZG, self.h2_1_GJ, self.h2_1_TT, self.h2_1_Data, self.h2_1_tot)
		FindAndSetMax(self.h3_sig10, self.h3_sig25, self.h3_sig50, self.h3_sig75, self.h3_WG, self.h3_ZG, self.h3_GJ, self.h3_TT, self.h3_Data, self.h3_tot)
		FindAndSetMax(self.h4_sig10, self.h4_sig25, self.h4_sig50, self.h4_sig75, self.h4_WG, self.h4_ZG, self.h4_GJ, self.h4_TT, self.h4_Data, self.h4_tot)
		FindAndSetMax(self.h5_sig10, self.h5_sig25, self.h5_sig50, self.h5_sig75, self.h5_WG, self.h5_ZG, self.h5_GJ, self.h5_TT, self.h5_Data, self.h5_tot)
		FindAndSetMax(self.h6_sig10, self.h6_sig25, self.h6_sig50, self.h6_sig75, self.h6_WG, self.h6_ZG, self.h6_GJ, self.h6_TT, self.h6_Data, self.h6_tot)
		FindAndSetMax(self.h7_sig10, self.h7_sig25, self.h7_sig50, self.h7_sig75, self.h7_WG, self.h7_ZG, self.h7_GJ, self.h7_TT, self.h7_Data, self.h7_tot)
		FindAndSetMax(self.h8_sig10, self.h8_sig25, self.h8_sig50, self.h8_sig75, self.h8_WG, self.h8_ZG, self.h8_GJ, self.h8_TT, self.h8_Data, self.h8_tot)
		FindAndSetMax(self.h9_sig10, self.h9_sig25, self.h9_sig50, self.h9_sig75, self.h9_WG, self.h9_ZG, self.h9_GJ, self.h9_TT, self.h9_Data, self.h9_tot)
		
		FindAndSetMax(self.h1_sig10_presel, self.h1_sig25_presel, self.h1_sig50_presel, self.h1_sig75_presel, self.h1_WG_presel, self.h1_ZG_presel, self.h1_GJ_presel, self.h1_TT_presel, self.h1_Data_presel, self.h1_tot_presel)
		FindAndSetMax(self.h2_sig10_presel, self.h2_sig25_presel, self.h2_sig50_presel, self.h2_sig75_presel, self.h2_WG_presel, self.h2_ZG_presel, self.h2_GJ_presel, self.h2_TT_presel, self.h2_Data_presel, self.h2_tot_presel)
		FindAndSetMax(self.h2_1_sig10_presel, self.h2_1_sig25_presel, self.h2_1_sig50_presel, self.h2_1_sig75_presel, self.h2_1_WG_presel, self.h2_1_ZG_presel, self.h2_1_GJ_presel, self.h2_1_TT_presel, self.h2_1_Data_presel, self.h2_1_tot_presel)
		FindAndSetMax(self.h3_sig10_presel, self.h3_sig25_presel, self.h3_sig50_presel, self.h3_sig75_presel, self.h3_WG_presel, self.h3_ZG_presel, self.h3_GJ_presel, self.h3_TT_presel, self.h3_Data_presel, self.h3_tot_presel)
		FindAndSetMax(self.h4_sig10_presel, self.h4_sig25_presel, self.h4_sig50_presel, self.h4_sig75_presel, self.h4_WG_presel, self.h4_ZG_presel, self.h4_GJ_presel, self.h4_TT_presel, self.h4_Data_presel, self.h4_tot_presel)
		FindAndSetMax(self.h5_sig10_presel, self.h5_sig25_presel, self.h5_sig50_presel, self.h5_sig75_presel, self.h5_WG_presel, self.h5_ZG_presel, self.h5_GJ_presel, self.h5_TT_presel, self.h5_Data_presel, self.h5_tot_presel)
		
		FindAndSetMax(self.p1_sig10, self.p1_sig25, self.p1_sig50, self.p1_sig75, self.p1_WG, self.p1_ZG, self.p1_GJ, self.p1_TT, self.p1_Data, self.p1_tot)
		FindAndSetMax(self.p1_1_sig10, self.p1_1_sig25, self.p1_1_sig50, self.p1_1_sig75, self.p1_1_WG, self.p1_1_ZG, self.p1_1_GJ, self.p1_1_TT, self.p1_1_Data, self.p1_1_tot)
		FindAndSetMax(self.p2_sig10, self.p2_sig25, self.p2_sig50, self.p2_sig75, self.p2_WG, self.p2_ZG, self.p2_GJ, self.p2_TT, self.p2_Data, self.p2_tot)
		FindAndSetMax(self.p3_sig10, self.p3_sig25, self.p3_sig50, self.p3_sig75, self.p3_WG, self.p3_ZG, self.p3_GJ, self.p3_TT, self.p3_Data, self.p3_tot)
		FindAndSetMax(self.p4_sig10, self.p4_sig25, self.p4_sig50, self.p4_sig75, self.p4_WG, self.p4_ZG, self.p4_GJ, self.p4_TT, self.p4_Data, self.p4_tot)
		FindAndSetMax(self.p5_sig10, self.p5_sig25, self.p5_sig50, self.p5_sig75, self.p5_WG, self.p5_ZG, self.p5_GJ, self.p5_TT, self.p5_Data, self.p5_tot)
		
		FindAndSetMax(self.f1_sig10, self.f1_sig25, self.f1_sig50, self.f1_sig75, self.f1_WG, self.f1_ZG, self.f1_GJ, self.f1_TT, self.f1_Data, self.f1_tot)
		FindAndSetMax(self.f1_1_sig10, self.f1_1_sig25, self.f1_1_sig50, self.f1_1_sig75, self.f1_1_WG, self.f1_1_ZG, self.f1_1_GJ, self.f1_1_TT, self.f1_1_Data, self.f1_1_tot)
		FindAndSetMax(self.f2_sig10, self.f2_sig25, self.f2_sig50, self.f2_sig75, self.f2_WG, self.f2_ZG, self.f2_GJ, self.f2_TT, self.f2_Data, self.f2_tot)
		FindAndSetMax(self.f3_sig10, self.f3_sig25, self.f3_sig50, self.f3_sig75, self.f3_WG, self.f3_ZG, self.f3_GJ, self.f3_TT, self.f3_Data, self.f3_tot)
		FindAndSetMax(self.f4_sig10, self.f4_sig25, self.f4_sig50, self.f4_sig75, self.f4_WG, self.f4_ZG, self.f4_GJ, self.f4_TT, self.f4_Data, self.f4_tot)
		FindAndSetMax(self.f5_sig10, self.f5_sig25, self.f5_sig50, self.f5_sig75, self.f5_WG, self.f5_ZG, self.f5_GJ, self.f5_TT, self.f5_Data, self.f5_tot)
		

		LUMI = 5.467 #Temporary luminosity with 10% of 2018 data
		...
		p12.SetLogy()
		p22 = TPad("pad2", "short", 0,0.01,1.0,0.23)
		p12.Draw()
		p22.Draw()
		p12.cd() #top
		self.h1_tot.SetTitle("Softdrop Mass")
...
#		gPad.SetLogy()
		...
		cheap1.Draw("hist")
		pull1 = makePull(self.h1_Data, self.h1_tot)
		pull1.Draw("esame")
		p22.RedrawAxis()
		c1.SaveAs("./plots/"+name+"_soft_trigger.png")
		c1.Close()
...
#		gPad.SetLogy()
		...
		cheap2.Draw("hist")
		pull2 = makePull(self.h2_Data, self.h2_tot)
		pull2.Draw("esame")
		p22.RedrawAxis()
		c2.SaveAs("./plots/"+name+"_jet_pt_trigger.png")
		c2.Close()
...
#		gPad.SetLogy()
		...
		cheap2.Draw("hist")
		pull3 = makePull(self.h3_Data, self.h3_tot)
		pull3.Draw("esame")
		p22.RedrawAxis()
		c3.SaveAs("./plots/"+name+"_jet_eta_trigger.png")
		c3.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.h4_tot.SetTitle("Photon pT")
...
#		gPad.SetLogy()
		...
		cheap4.Draw("hist")
		pull4 = makePull(self.h4_Data, self.h4_tot)
		pull4.Draw("esame")
		p22.RedrawAxis()
		c4.SaveAs("./plots/"+name+"_photon_pt_trigger.png")
		c4.Close()
...
#		gPad.SetLogy()
		...
		cheap5.Draw("hist")
		pull5 = makePull(self.h5_Data, self.h5_tot)
		pull5.Draw("esame")
		p22.RedrawAxis()
		c5.SaveAs("./plots/"+name+"_rho_trigger.png")
		c5.Close()
...
#		gPad.SetLogy()
		...
		cheap6.Draw("hist")
		pull6 = makePull(self.h6_Data, self.h6_tot)
		pull6.Draw("esame")
		p22.RedrawAxis()
		c6.SaveAs("./plots/"+name+"_n2_trigger.png")
		c6.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.h1_tot_presel.SetTitle("Pre-Selection Softdrop Mass")
...
#		gPad.SetLogy()
		...
		pull1_presel = makePull(self.h1_Data_presel, self.h1_tot_presel)
		pull1_presel.Draw("esame")
		p22.RedrawAxis()
		c1_presel.SaveAs("./plots/"+name+"_soft_presel_trigger.png")
		c1_presel.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.h2_tot_presel.SetTitle("Pre-Selection Jet pT")
...
#		gPad.SetLogy()
		...
		pull2_presel = makePull(self.h2_Data_presel, self.h2_tot_presel)
		pull2_presel.Draw("esame")
		p22.RedrawAxis()
		c2_presel.SaveAs("./plots/"+name+"_jet_pt_presel_trigger.png")
		c2_presel.Close()
		...
		p12 = TPad("pad1", "tall", 0,0.175,1,1)
		p12.SetLogy()
		p32 = TPad("pad2", "short", 0,0.01,1.0,0.23)
		p12.Draw()
		p32.Draw()
		p12.cd() #top
		self.h3_tot_presel.SetTitle("Pre-Selection Jet Eta")
...
#		gPad.SetLogy()
		...
		pull3_presel = makePull(self.h3_Data_presel, self.h3_tot_presel)
		pull3_presel.Draw("esame")
		p32.RedrawAxis()
		c3_presel.SaveAs("./plots/"+name+"_jet_eta_presel_trigger.png")
		c3_presel.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.h4_tot_presel.SetTitle("Pre-Selection Photon pT")
...
#		gPad.SetLogy()
		...
		pull4_presel = makePull(self.h4_Data_presel, self.h4_tot_presel)
		pull4_presel.Draw("esame")
		p22.RedrawAxis()
		c4_presel.SaveAs("./plots/"+name+"_photon_pt_presel_trigger.png")
		c4_presel.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.h5_tot_presel.SetTitle("Pre-Selection Rho")
...
#		gPad.SetLogy()
		...
		pull5_presel = makePull(self.h5_Data_presel, self.h5_tot_presel)
		pull5_presel.Draw("esame")
		p22.RedrawAxis()
		c5_presel.SaveAs("./plots/"+name+"_rho_presel_trigger.png")
		c5_presel.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.p1_tot.SetTitle("Passing Softdrop Mass")
...
#		gPad.SetLogy()
		...
		cheap1_p.Draw("hist")
		pull1_p = makePull(self.p1_Data, self.p1_tot)
		pull1_p.Draw("esame")
		p22.RedrawAxis()
		c1_p.SaveAs("./plots/"+name+"_pass_soft_trigger.png")
		c1_p.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.p2_tot.SetTitle("Passing Jet pT")
...
#		gPad.SetLogy()
		...
		cheap2_p.Draw("hist")
		pull2_p = makePull(self.p2_Data, self.p2_tot)
		pull2_p.Draw("esame")
		p22.RedrawAxis()
		c2_p.SaveAs("./plots/"+name+"_pass_jet_pt_trigger.png")
		c2_p.Close()
		...
		p32.Draw()
		p12.cd() #top
		self.p3_tot.SetTitle("Passing Jet Eta")
...
#		gPad.SetLogy()
		...
		cheap3_p.Draw("hist")
		pull3_p = makePull(self.p3_Data, self.p3_tot)
		pull3_p.Draw("esame")
		p32.RedrawAxis()
		c3_p.SaveAs("./plots/"+name+"_pass_jet_eta_trigger.png")
		c3_p.Close()
		...
		p22.Draw()
		p42.cd() #top
		self.p4_tot.SetTitle("Passing Photon pT")
...
#		gPad.SetLogy()
		...
		cheap4_p.Draw("hist")
		pull4_p = makePull(self.p4_Data, self.p4_tot)
		pull4_p.Draw("esame")
		p22.RedrawAxis()
		c4_p.SaveAs("./plots/"+name+"_pass_pho_pt_trigger.png")
		c4_p.Close()
		...
		p22.Draw()
		p52.cd() #top
		self.p5_tot.SetTitle("Passing Rho")
...
#		gPad.SetLogy()
		...
		cheap5_p.Draw("hist")
		pull5_p = makePull(self.p5_Data, self.p5_tot)
		pull5_p.Draw("esame")
		p22.RedrawAxis()
		c5_p.SaveAs("./plots/"+name+"_pass_rho_trigger.png")
		c5_p.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.f1_tot.SetTitle("Failing Softdrop Mass")
...
#		gPad.SetLogy()
		...
		cheap1_f.Draw("hist")
		pull1_f = makePull(self.f1_Data, self.f1_tot)
		pull1_f.Draw("esame")
		p22.RedrawAxis()
		c1_f.SaveAs("./plots/"+name+"_fail_soft_trigger.png")
		c1_f.Close()
		...
		p22.Draw()
		p12.cd() #top
		self.f2_tot.SetTitle("Failing Jet pT")
...
#		gPad.SetLogy()
		...
		cheap2_f.Draw("hist")
		pull2_f = makePull(self.f2_Data, self.f2_tot)
		pull2_f.Draw("esame")
		p22.RedrawAxis()
		c2_f.SaveAs("./plots/"+name+"_fail_jet_pt_trigger.png")
		c2_f.Close()
		...
		p32.Draw()
		p12.cd() #top
		self.f3_tot.SetTitle("Failing Jet pT")
...
#		gPad.SetLogy()
		...
		cheap3_f.Draw("hist")
		pull3_f = makePull(self.f3_Data, self.f3_tot)
		pull3_f.Draw("esame")
		p32.RedrawAxis()
		c3_f.SaveAs("./plots/"+name+"_fail_jet_eta_trigger.png")
		c3_f.Close()
		...
		p22.Draw()
		p42.cd() #top
		self.f4_tot.SetTitle("Failing Photon pT")
...
#		gPad.SetLogy()
		...
		cheap4_f.Draw("hist")
		pull4_f = makePull(self.f4_Data, self.f4_tot)
		pull4_f.Draw("esame")
		p22.RedrawAxis()
		c4_f.SaveAs("./plots/"+name+"_fail_rho_pt_trigger.png")
		c4_f.Close()
		...
		p22.Draw()
		p52.cd() #top
		self.f5_tot.SetTitle("Failing Rho")
...
#		gPad.SetLogy()
		...
		cheap5_f.Draw("hist")
		pull5_f = makePull(self.f5_Data, self.f5_tot)
		pull5_f.Draw("esame")
		p22.RedrawAxis()
		c5_f.SaveAs("./plots/"+name+"_fail_rho_trigger.png")
		c5_f.Close()

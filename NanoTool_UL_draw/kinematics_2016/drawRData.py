...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, ifile8, ifile9, ifile10, o):
		...
		ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_draw/kinematics_2016/"+o,"RECREATE")
...
#		self.h1_sig50.Draw("same hist")
		...
		l1.SetFillColor(0)
		l1.SetLineColor(0)
                l1.AddEntry(self.h1_Data, "10% of 2016 Data")
...
#		self.h2_sig50.Draw("same hist")
		...
		l2.SetFillColor(0)
		l2.SetLineColor(0)
                l2.AddEntry(self.h2_Data, "10% of 2016 Data")
...
#		self.h3_sig50.Draw("same hist")
		...
		l3.SetFillColor(0)
		l3.SetLineColor(0)
                l3.AddEntry(self.h3_Data, "10% of 2016 Data")
...
#		self.h4_sig50.Draw("same hist")
		...
		l4.SetFillColor(0)
		l4.SetLineColor(0)
                l4.AddEntry(self.h4_Data, "10% of 2016 Data")
...
#		self.h5_sig50.Draw("same hist")
		...
		l5.SetFillColor(0)
		l5.SetLineColor(0)
                l5.AddEntry(self.h5_Data, "10% of 2016 Data")
...
#		self.h6_sig50.Draw("same hist")
		...
		l6.SetFillColor(0)
		l6.SetLineColor(0)
                l6.AddEntry(self.h6_Data, "10% of 2016 Data")
...
#		self.h10_sig50.Draw("same hist")
		...
		l10.SetFillColor(0)
		l10.SetLineColor(0)
                l10.AddEntry(self.h10_Data, "10% of 2016 Data")
...
#		self.h11_sig50.Draw("same hist")
		...
		l11.SetFillColor(0)
		l11.SetLineColor(0)
                l11.AddEntry(self.h11_Data, "10% of 2016 Data")
...
#		self.h12_sig50.Draw("same hist")
		...
		l12.SetFillColor(0)
		l12.SetLineColor(0)
                l12.AddEntry(self.h12_Data, "10% of 2016 Data")
...
#		self.h13_sig50.Draw("same hist")
		...
		l13.SetFillColor(0)
		l13.SetLineColor(0)
                l13.AddEntry(self.h13_Data, "10% of 2016 Data")
...
#		l1_presel.SetLineColor(0)
 #               l1_presel.AddEntry(self.h1_Data_presel, "10% of 2016 Data_presel")
...
#		l2_presel.SetLineColor(0)
 #               l2_presel.AddEntry(self.h2_Data_presel, "10% of 2016 Data_presel")
...
#		l3_presel.SetLineColor(0)
 #               l3_presel.AddEntry(self.h3_Data_presel, "10% of 2016 Data_presel")
...
#		l4_presel.SetLineColor(0)
 #               l4_presel.AddEntry(self.h4_Data_presel, "10% of 2016 Data_presel")
...
#		l5_presel.SetLineColor(0)
 #               l5_presel.AddEntry(self.h5_Data_presel, "10% of 2016 Data_presel")
...
#		l6_presel.SetLineColor(0)
 ##               l6_presel.AddEntry(self.h6_Data_presel, "10% of 2016 Data_presel")
...
#                l10_presel.AddEntry(self.h10_Data_presel, "10% of 2016 Data_presel")
...
#		self.p1_sig50.Draw("same hist")
		...
		l1_p.SetFillColor(0)
		l1_p.SetLineColor(0)
                l1_p.AddEntry(self.p1_Data, "10% of 2016 Data")
...
#		self.p2_sig50.Draw("same hist")
		...
		l2_p.SetFillColor(0)
		l2_p.SetLineColor(0)
                l2_p.AddEntry(self.p2_Data, "10% of 2016 Data")
...
#		self.p3_sig50.Draw("same hist")
		...
		l3_p.SetFillColor(0)
		l3_p.SetLineColor(0)
                l3_p.AddEntry(self.p3_Data, "10% of 2016 Data")
...
#		self.p4_sig50.Draw("same hist")
		...
		l4_p.SetFillColor(0)
		l4_p.SetLineColor(0)
                l4_p.AddEntry(self.p4_Data, "10% of 2016 Data")
...
#		self.p5_sig50.Draw("same hist")
		...
		l5_p.SetFillColor(0)
		l5_p.SetLineColor(0)
                l5_p.AddEntry(self.p5_Data, "10% of 2016 Data")
...
#		self.p10_sig50.Draw("same hist")
		...
		l10_p.SetLineColor(0)
                l10_p.AddEntry(self.p10_Data, "10% of 2016 Data")
...
#		self.f1_sig50.Draw("same hist")
		...
		l1_f.SetFillColor(0)
		l1_f.SetLineColor(0)
                l1_f.AddEntry(self.f1_Data, "10% of 2016 Data")
...
#		self.f2_sig50.Draw("same hist")
		...
		l2_f.SetFillColor(0)
		l2_f.SetLineColor(0)
                l2_f.AddEntry(self.f2_Data, "10% of 2016 Data")
...
#		self.f3_sig50.Draw("same hist")
		...
		l3_f.SetFillColor(0)
		l3_f.SetLineColor(0)
                l3_f.AddEntry(self.f3_Data, "10% of 2016 Data")
...
#		self.f4_sig50.Draw("same hist")
		...
		l4_f.SetFillColor(0)
		l4_f.SetLineColor(0)
                l4_f.AddEntry(self.f4_Data, "10% of 2016 Data")
...
#		self.f5_sig50.Draw("same hist")
		...
		l5_f.SetFillColor(0)
		l5_f.SetLineColor(0)
                l5_f.AddEntry(self.f5_Data, "10% of 2016 Data")
...
#		self.f10_sig50.Draw("same hist")
		...
		l10_f.SetLineColor(0)
                l10_f.AddEntry(self.f10_Data, "10% of 2016 Data")
...
#		gPad.SetLogy()
		...
		self.h2_1_Data.SetTitle("2016 Data Jet pT (Selection Applied)")

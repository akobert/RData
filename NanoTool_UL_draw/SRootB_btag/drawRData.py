...
#		ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_draw/SRootB_btag/"+o,"RECREATE")
		...
		lin2.Draw()
                ...
                gPad.Update()
		c5.SaveAs("./plots/SRootB_btag_"+name+"_5.png")
		c5.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c10.SaveAs("./plots/SRootB_btag_"+name+"_10.png")
		c10.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c15.SaveAs("./plots/SRootB_btag_"+name+"_15.png")
		c15.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c20.SaveAs("./plots/SRootB_btag_"+name+"_20.png")
		c20.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c25.SaveAs("./plots/SRootB_btag_"+name+"_25.png")
		c25.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c30.SaveAs("./plots/SRootB_btag_"+name+"_30.png")
		c30.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c50.SaveAs("./plots/SRootB_btag_"+name+"_50.png")
		c50.Close()

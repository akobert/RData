...
class drawRData:
	def __init__(self, name, sfile1, sfile2, sfile3, sfile4, sfile5, sfile6, o):
		...
		c5 = TCanvas()
		c5.cd()
		self.M25.SetTitle("2016APV S/Root(B) vs. Xqq/(Xqq+QCD) Score Cut")
		self.M25.Draw("ALP*")
		self.M10.Draw("LP*")
		self.M50.Draw("LP*")
		self.M75.Draw("LP*")
		...
		self.ZG.Draw("LP*")
                ...
                l1.Draw()
                gPad.Update()
		c5.SaveAs("./plots/SRootB_barrel_Xqq_2016APV.png")
		c5.Close()
		
		c6 = TCanvas()
		c6.cd()
		self.M25_all.SetTitle("2016APV S/Root(B) vs. (Xqq+Xcc+Xbb)/(Xqq+Xcc+Xbb+QCD) Score Cut")
		...
		self.ZG_all.Draw("LP*")
                ...
                l1.Draw()
                gPad.Update()
		c6.SaveAs("./plots/SRootB_barrel_XqqALL_2016APV.png")
		c6.Close()

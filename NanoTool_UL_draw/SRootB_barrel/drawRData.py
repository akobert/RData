...
class drawRData:
	def __init__(self, name, sfile1, sfile2, sfile3, sfile4, sfile5, sfile6, sfile7, bfile1, bfile2, bfile3, bfile4, bfile5, bfile6, bfile7, t, o, low, high):
		...
		print("Low Bin: "+str(sig_low))
		print("High Bin: "+str(sig_high))
		...
		lin2.Draw()
                ...
                gPad.Update()
		c5.SaveAs("./plots/SRootB_barrel_"+name+"_5.png")
		c5.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c10.SaveAs("./plots/SRootB_barrel_"+name+"_10.png")
		c10.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c15.SaveAs("./plots/SRootB_barrel_"+name+"_15.png")
		c15.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c20.SaveAs("./plots/SRootB_barrel_"+name+"_20.png")
		c20.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c25.SaveAs("./plots/SRootB_barrel_"+name+"_25.png")
		c25.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c30.SaveAs("./plots/SRootB_barrel_"+name+"_30.png")
		c30.Close()
		...
		lin2.Draw()
                ...
                gPad.Update()
		c50.SaveAs("./plots/SRootB_barrel_"+name+"_50.png")
		c50.Close()
		...
		c_srb.SaveAs("./plots/SRB_barrel_"+name+".png")
		c_srb.Close()
		...
		c_srb_high.SaveAs("./plots/SRB_high_barrel_"+name+".png")
		c_srb_high.Close()

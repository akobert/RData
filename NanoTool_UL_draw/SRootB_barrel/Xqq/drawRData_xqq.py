...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, o):
		...
		ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_draw/SRootB_barrel/Xqq/"+o,"RECREATE")
		...
		FindAndSetMax(self.h1,self.h2,self.h3,self.h4,self.h5,self.h6,self.h7)
		FindAndSetMax(self.h1_all,self.h2_all,self.h3_all,self.h4_all,self.h5_all,self.h6_all,self.h7_all)
...
#		self.h1_all.GetYaxis().SetRangeUser(1,15000)
		...
		c1.cd()
		c1.SetLogy()
		self.h1.SetTitle("2018 ParticleNetMD Xqq/(Xqq+QCD) Score")
		...
		c1.SaveAs("./plots/Xqq_QCD_2018.png")
		c1.Close()
		
		c2 = TCanvas()
		c2.cd()
		c2.SetLogy()
		self.h1_all.SetTitle("2018 ParticleNetMD (Xqq+Xcc+Xbb)/(Xqq+Xcc+Xbb+QCD) Score")
		...
		l2.Draw()
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		c2.SaveAs("./plots/Xqq_ALLQQ_2018.png")
		c2.Close()

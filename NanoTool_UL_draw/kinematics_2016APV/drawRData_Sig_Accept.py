...
class drawRData:
	...
	#	self.effOR_graph.SetLineColor(kViolet)
		...
		#gPad.SetLogy()
		c1.SaveAs("./"+name+"_Total_2016APV.png")
		c1.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c2.SaveAs("./"+name+"_All_2016APV.png")
		c2.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c3.SaveAs("./"+name+"_Pass_2016APV.png")
		c3.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c4.SaveAs("./"+name+"_Fail_2016APV.png")
		c4.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c5.SaveAs("./"+name+"_Accept_2016APV.png")
		c5.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c6.SaveAs("./"+name+"_Pass_Ratio_2016APV.png")
		c6.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c7.SaveAs("./"+name+"_Selected_Ratio_2016APV.png")
		c7.Close()

...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, ifile8, ifile9, ifile10, o):
		...
		self.p4_tot = TH1F("pass_pho_pt_tot", "Total Passing Background Photon pT", 50, 0, 1000)
		...
		self.f4_tot = TH1F("fail_pho_pt_tot", "Total Failing Background Photon pT", 50, 0, 1000)
...
#		gPad.SetLogy()
		...
		p22.Draw()
		p12.cd() #top
		self.h10_tot.SetTitle("Photon Eta")
...
#		gPad.SetLogy()
		...
		cheap10.Draw("hist")
		pull10 = makePull(self.h10_Data, self.h10_tot)
		pull10.Draw("esame")
		p22.RedrawAxis()
...
#		gPad.SetLogy()
		...
		p22.Draw()
		p12.cd() #top
		self.h6_tot_presel.SetTitle("Pre-Selection N2")
...
#		gPad.SetLogy()
		...
		cheap5_presel.Draw("hist")
		pull6_presel = makePull(self.h6_Data_presel, self.h6_tot_presel)
		...
		p22.Draw()
		p12.cd() #top
		self.h10_tot_presel.SetTitle("Pre-Selection Photon Eta")
		...
		l10_presel = TLegend(.12, .53, .33, .89)
...
#		gPad.SetLogy()
		...
		pull10_presel = makePull(self.h10_Data_presel, self.h10_tot_presel)
...
#		gPad.SetLogy()
		...
		p22.Draw()
		p52.cd() #top
		self.p10_tot.SetTitle("Passing Photon Eta")
...
#		gPad.SetLogy()
		...
		cheap10_p.Draw("hist")
		pull10_p = makePull(self.p10_Data, self.p10_tot)
		pull10_p.Draw("esame")
		p22.RedrawAxis()
...
#		gPad.SetLogy()
		...
		p22.Draw()
		p52.cd() #top
		self.f10_tot.SetTitle("Failing Photon Eta")
...
#		gPad.SetLogy()
		...
		cheap10_f.Draw("hist")
		pull10_f = makePull(self.f10_Data, self.f10_tot)
		pull10_f.Draw("esame")
		p22.RedrawAxis()

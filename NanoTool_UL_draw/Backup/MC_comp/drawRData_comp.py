...
class drawRData:
	def __init__(self, name, ifile1, ifile2):
		...
		print("2017 AK8 HT: "+str(self.h8_2017.Integral()))
		print("2018 AK8 HT: "+str(self.h8_2018.Integral()))
		print("2017/2018 AK8 HT: "+str(self.h8_2017.Integral()/self.h8_2018.Integral()))
		...
		l1.SetFillColor(0)
		l1.SetLineColor(0)
                l1.AddEntry(self.h1_2017, "2017 GJ")
                l1.AddEntry(self.h1_2018, "2018 GJ")
                l1.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		l2.SetFillColor(0)
		l2.SetLineColor(0)
                l2.AddEntry(self.h2_2017, "2017 GJ")
                l2.AddEntry(self.h2_2018, "2018 GJ")
                l2.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		l3.SetFillColor(0)
		l3.SetLineColor(0)
                l3.AddEntry(self.h3_2017, "2017 GJ")
                l3.AddEntry(self.h3_2018, "2018 GJ")
                l3.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		pull3.Draw("esame")
		p22.RedrawAxis()
		c3.SaveAs("./plots/"+name+"_jet_pt.png")
		c3.Close()
		...
		l4.SetFillColor(0)
		l4.SetLineColor(0)
                l4.AddEntry(self.h4_2017, "2017 GJ")
                l4.AddEntry(self.h4_2018, "2018 GJ")
                l4.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		pull4.Draw("esame")
		p22.RedrawAxis()
		c4.SaveAs("./plots/"+name+"_thin_jet_pt.png")
		c4.Close()
		...
		l5.SetFillColor(0)
		l5.SetLineColor(0)
                l5.AddEntry(self.h5_2017, "2017 GJ")
                l5.AddEntry(self.h5_2018, "2018 GJ")
                l5.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		l6.SetFillColor(0)
		l6.SetLineColor(0)
                l6.AddEntry(self.h6_2017, "2017 GJ")
                l6.AddEntry(self.h6_2018, "2018 GJ")
                l6.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		pull6.Draw("esame")
		p22.RedrawAxis()
		c6.SaveAs("./plots/"+name+"_nPV_good.png")
		c6.Close()
		...
		l7.SetFillColor(0)
		l7.SetLineColor(0)
                l7.AddEntry(self.h7_2017, "2017 GJ")
                l7.AddEntry(self.h7_2018, "2018 GJ")
                l7.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		pull7.Draw("esame")
		p22.RedrawAxis()
		c7.SaveAs("./plots/"+name+"_HT_AK4.png")
		c7.Close()
		...
		l8.SetFillColor(0)
		l8.SetLineColor(0)
                l8.AddEntry(self.h8_2017, "2017 GJ")
                l8.AddEntry(self.h8_2018, "2018 GJ")
                l8.Draw()
#		gPad.SetLogy()
		p22.cd() #bottom
		...
		pull8.Draw("esame")
		p22.RedrawAxis()
		c8.SaveAs("./plots/"+name+"_HT_AK8.png")
		c8.Close()
		...
		pull1.Draw("esame")
		p22.RedrawAxis()
		c1_logy.SaveAs("./plots/"+name+"_soft_logy.png")
		c1_logy.Close()
		...
		pull2.Draw("esame")
		p22.RedrawAxis()
		c2_logy.SaveAs("./plots/"+name+"_thin_soft_logy.png")
		c2_logy.Close()
		...
		pull3.Draw("esame")
		p22.RedrawAxis()
		c3_logy.SaveAs("./plots/"+name+"_jet_pt_logy.png")
		c3_logy.Close()
		...
		pull4.Draw("esame")
		p22.RedrawAxis()
		c4_logy.SaveAs("./plots/"+name+"_thin_jet_pt_logy.png")
		c4_logy.Close()
		...
		pull5.Draw("esame")
		p22.RedrawAxis()
		c5_logy.SaveAs("./plots/"+name+"_nPV_logy.png")
		c5_logy.Close()
		...
		pull6.Draw("esame")
		p22.RedrawAxis()
		c6_logy.SaveAs("./plots/"+name+"_nPV_good_logy.png")
		c6_logy.Close()
		...
		pull7.Draw("esame")
		p22.RedrawAxis()
		c7_logy.SaveAs("./plots/"+name+"_HT_AK4_logy.png")
		c7_logy.Close()
		...
		pull8.Draw("esame")
		p22.RedrawAxis()
		c8_logy.SaveAs("./plots/"+name+"_HT_AK8_logy.png")
		c8_logy.Close()

...
class drawRData:
	def __init__(self, name, ifile1, ifile2, ifile3, ifile4, ifile5, ifile6, ifile7, ifile8, ifile9, ifile10, o):
		...
		ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_draw/kinematics_barrel/"+o,"RECREATE")
...
#		gPad.SetLogy()
		...
		self.h2_1_Data.GetXaxis().SetRangeUser(100,800)
		self.h2_1_Data.SetTitle("2018 Data Jet pT (Selection Applied)")
		...
		pt2 = TLine(170,0,170,7000)
		pt3 = TLine(220,0,220,7000)
		pt4 = TLine(300,0,300,7000)
		pt5 = TLine(400,0,400,7000)
		pt6 = TLine(700,0,700,7000)
#		pt7 = TLine(1200,0,1200,7000)

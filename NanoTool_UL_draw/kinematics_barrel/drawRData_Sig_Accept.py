...
class drawRData:
	...
	#	self.effOR_graph.SetLineColor(kViolet)
		...
		#gPad.SetLogy()
		c1.SaveAs("./"+name+"_Total_2018.png")
		c1.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c5.SaveAs("./"+name+"_Accept_2018.png")
		c5.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c6.SaveAs("./"+name+"_Pass_Ratio_2018.png")
		c6.Close()
		...
		AddCMSLumi(ROOT.gPad, LUMI, cmsextra)
		#gPad.SetLogy()
		c7.SaveAs("./"+name+"_Selected_Ratio_2018.png")
		c7.Close()

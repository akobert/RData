...
def DataPro(sample, fname):
	...
	ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/Xqq_Test_2018/output/RData_" + fname + ".root", "RECREATE")
	ofile.cd()
...
#	rho_pass += float(Rdf_cflow.Count().GetValue())
	...
	Rdf = Rdf.Define("QCD", "selectedPatJetsAK8PFPuppi_ParticleNetMD_probQCD[jIndex]+selectedPatJetsAK8PFPuppi_ParticleNetMD_probQCDb[jIndex]+selectedPatJetsAK8PFPuppi_ParticleNetMD_probQCDbb[jIndex]+selectedPatJetsAK8PFPuppi_ParticleNetMD_probQCDc[jIndex]+selectedPatJetsAK8PFPuppi_ParticleNetMD_probQCDcc[jIndex]")
	Rdf = Rdf.Define("Xqq", "selectedPatJetsAK8PFPuppi_ParticleNetMD_probXqq[jIndex]")
	Rdf = Rdf.Define("Xcc", "selectedPatJetsAK8PFPuppi_ParticleNetMD_probXcc[jIndex]")
	Rdf = Rdf.Define("Xbb", "selectedPatJetsAK8PFPuppi_ParticleNetMD_probXbb[jIndex]")

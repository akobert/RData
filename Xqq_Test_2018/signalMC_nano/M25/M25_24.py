...
sys.path.insert(1, '/home/akobert/CMSSW_11_1_0_pre7/src/RData/Xqq_Test_2018/')
...
if __name__ == "__main__":
	...
	files = ["/cms/akobert/NanoToolOutput/UL/signal/M25/jetToolbox_M25_BTagTest_30.root", str(59.82 * 13290.0/496157.0), 1, "mc"]

#	cutfile = "/home/akobert/CMSSW_11_1_0_pre7/src/RData/2018/NanoTool_UL_btag_percentage/RData_Cutoffs_nano.root"
#	cf = TFile(cutfile)
...
//                                int xbin = int(((r + 8.0)*4.0)+1.0);
//                                int ybin = int((pt/20.0)+1.0);

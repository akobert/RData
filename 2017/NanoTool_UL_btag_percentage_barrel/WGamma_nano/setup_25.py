...
if __name__ == "__main__":
    ...
    for process in range(10):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/2017/NanoTool_UL_btag_percentage_barrel/nano_Sample_25.py", "r")
        newFile = open("WGamma" + str(process) + "_25.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(41.48 * 8630.0/10283695.0), 1, \"mc\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"WGamma_UL_nano_"+str(process)+"_25\""

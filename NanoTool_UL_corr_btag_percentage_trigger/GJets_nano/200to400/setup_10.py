...
if __name__ == "__main__":
    ...
    for process in range(409):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag_percentage_trigger/nano_Sample_10.py", "r")
        newFile = open("GJ200to400_" + str(process) + "_10.py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(54.67 * 2183000.0/19755305.0), 1, \"mc\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"GJ200to400_UL_nano_"+str(process)+"_10\""

...
if __name__ == "__main__":
    ...
    for process in range(39):
    	template = open("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_corr_btag_percentage_trigger/nano_Sample.py", "r")
        newFile = open("M20_" + str(process) + ".py", "a+")
	...
	newline1 = "files = [\""+str(readLine[:-1])+"\", str(54.67 * 15660.0/493822.0), 1, \"mc\"]"
	
	oldline2 = "fname = \"DataA_present_UL_0\""
	newline2 = "fname = \"M20_UL_nano_"+str(process)+"\""

  ...
  #      ofile.WriteObject(h7, "test_rho")
   #     ofile.WriteObject(h8, "test_photon_eta")
	...
	c0 = TCanvas()
        ...
        #c0.SetLogy()
        h2.Draw("hist")
        c0.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_softdrop.png")
        c0.Close()
	...
	c1 = TCanvas()
        ...
        #c1.SetLogy()
        p1.Draw("hist")
        c1.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_pass_soft.png")
        c1.Close()

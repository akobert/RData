...
#	h9 = TH1F("h9", "N2DDT", 50, -.5, .5)
	...
	h20_1 = TH2F("pt_n2ddt", "Jet pT vs. N2DDT", 40, 0, 2000, 50, -.5, .5)
        ...
        h26 = TH2F("pt_photon_jet", "Jet pT vs. Photon pT", 40, 0, 2000, 40, 0, 2000)
        h27 = TH2F("photon_jet_ratio_pt", "Jet pT vs. Photon pT / Jet pT", 40, 0, 2000, 40, 0, 3)
...
#		pass_sig_thin_pass_weight125_slice = 0
		...
		Rdf_noCut = RDF(Chain)
	#	Rdf_PreSel = Rdf_noCut.Filter("(HLT_Photon110EB_TightID_TightIso > 0. || HLT_Photon175 > 0) && nPhoton > 0. && nselectedPatJetsAK8PFPuppi > 0. && selectedPatJetsAK8PFPuppi_softdropMass.size()>0")
...
#		
		...
		j21_w = Rdf_Pass.Histo2D(("pt_soft_pass_wide", "Passing Jet pT vs. Softdrop Mass", 8, widebins, 40, 0, 200), "jPt", "jM", "weight")
        	j21_w = j21_w.Clone()
		h21_w.Add(j21_w)
		...
		j23_w = Rdf_Fail.Histo2D(("pt_soft_fail_wide", "Failing Jet pT vs. Softdrop Mass", 8, widebins, 40, 0, 200), "jPt", "jM", "weight")
        	j23_w = j23_w.Clone()
		h23_w.Add(j23_w)
		...
		h25.Add(j25)
                ...
                j26 = Rdf_Final.Histo2D(("pt_photon_jet", "Jet pT vs. Photon pT", 40, 0, 2000, 40, 0, 2000), "jPt", "pPt", "weight")
                j26 = j26.Clone()
                j26.SetTitle("Jet pT vs. Photon pT")
                j26.SetXTitle("Jet pT")
                j26.SetYTitle("Photon pT")
                h26.Add(j26)

                j27 = Rdf_Final.Histo2D(("photon_jet_ratio_pt", "Jet pT vs. Photon pT / Jet pT", 40, 0, 2000, 40, 0, 3), "jPt", "pTratio", "weight")
                j27 = j27.Clone()
                j27.SetTitle("Jet pT vs. Photon pT / Jet pT")
                j27.SetXTitle("Jet pT")
                j27.SetYTitle("Photon pT / Jet pT")
                h27.Add(j27)
...
#        n1.SetLogy()
	...
	h25.SetTitle("Passing Jet pT vs. Rho")
        ...
        h26.SetTitle("Jet pT vs. Photon pT")
        ...
        h27.SetTitle("Jet pT vs. Photon pT / Jet pT")

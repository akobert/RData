...
#	h9 = TH1F("h9", "N2DDT", 50, -.5, .5)
	...
	ROOT.gInterpreter.Declare("Double_t widebins[6] = {200, 230, 254, 290, 362, 2000};")

	h21 = TH2F("jet_pt_soft_pass", "Passing Jet pT vs. Softdrop Mass", 40, 0, 2000, 40, 0, 200)
	h21_w = TH2F("jet_pt_soft_pass_wide", "Passing Jet pT vs. Softdrop Mass", 5, widebins, 40, 0, 200)
	...
	h23_w = TH2F("jet_pt_soft_fail_wide", "Failing Jet pT vs. Softdrop Mass", 5, widebins, 40, 0, 200)
...
#		pass_sig_thin_pass_weight125_slice = 0
	...
	#	Rdf_PreSel = Rdf_noCut.Filter("(HLT_Photon110EB_TightID_TightIso > 0. || HLT_Photon175 > 0) && nPhoton > 0. && nselectedPatJetsAK8PFPuppi > 0. && selectedPatJetsAK8PFPuppi_softdropMass.size()>0")
		...
		Rdf_cflow = Rdf_cflow.Filter("HLT_Photon175 >0.0")
...
#        	Rdf = Rdf.Define("sub_jM", "submass((selectedPatJetsAK8PFPuppiSoftDrop_Subjets_pt[jIndex]), selectedPatJetsAK8PFPuppiSoftDrop_Subjets_eta[jIndex], selectedPatJetsAK8PFPuppiSoftDrop_Subjets_phi[jIndex],selectedPatJetsAK8PFPuppiSoftDrop_Subjets_mass[jIndex], (selectedPatJetsAK8PFPuppiSoftDrop_Subjets_pt[1+jIndex]), selectedPatJetsAK8PFPuppiSoftDrop_Subjets_eta[1+jIndex], selectedPatJetsAK8PFPuppiSoftDrop_Subjets_phi[1+jIndex],selectedPatJetsAK8PFPuppiSoftDrop_Subjets_mass[1+jIndex])")
		...
		Rdf_Trig = Rdf.Filter("HLT_Photon175 > 0")
		trigcut += int(Rdf_Trig.Count().GetValue())

		Rdf_Final = Rdf.Filter("N2 >= 0.0 && Rho > -7 && Rho < -2  && dR >= 2.2 && HLT_Photon175 >0.0")
...
#		
		...
		j21_w = Rdf_Pass.Histo2D(("pt_soft_pass_wide", "Passing Jet pT vs. Softdrop Mass", 5, widebins, 40, 0, 200), "jPt", "jM", "weight")
        	j21_w = j21_w.Clone()
		h21_w.Add(j21_w)
		...
		j23_w = Rdf_Fail.Histo2D(("pt_soft_fail_wide", "Failing Jet pT vs. Softdrop Mass", 5, widebins, 40, 0, 200), "jPt", "jM", "weight")
        	j23_w = j23_w.Clone()
		h23_w.Add(j23_w)

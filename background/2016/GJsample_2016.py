...
from GJets_Processor_Percentage_2016 import *
...
if __name__ == "__main__":
	...
	cutfile = "/home/akobert/CMSSW_11_1_0_pre7/src/RData/verify/RData_Cutoffs_2016.root"
	cf = TFile(cutfile)
	...
	ROOT.gInterpreter.ProcessLine("auto cutoff = "+str(cut_ID)+";")
        ...
        cflow_code =    '''
                        ...
                        bool PID(RVec<float> ppt, RVec<float> peta, RVec<bool> pID, int nPho)
                        {
                                for(int i=0; i<nPho; i++)
                                {
                                        if(abs(peta[i]) < 2.4 && ppt[i] > 200 && pID[i])
                                        {
                                                return true;
                                        }
                                }
	...
	percentage = 20
	fname = "GJets_background_20_2016"

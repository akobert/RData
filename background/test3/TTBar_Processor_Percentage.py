...
#	h1 = TH1F("h1", "N2", 25, 0, .5)
	...
	h2_1 = TH1F("h2_1", "Low pT Softdrop Mass", 40, 0, 200)
...
#
		...
		Rdf_Final_lowpT = Rdf_Final.Filter("jPt > 110 && jPt < 200")
	
		t2_1 = Rdf_Final_lowpT.Histo1D(("t2_1", "Low pT Softdrop Mass", 40, 0, 200), "jM", "weight")
        	t2_1 = t2_1.Clone()
        	t2_1.SetTitle("Low pT Softdrop Mass")
...
#        ofile.WriteObject(h1, "test_N2")
	...
	ofile.WriteObject(h2_1, "lowpT_softdrop")
  ...
  #      ofile.WriteObject(h7, "test_rho")
   #     ofile.WriteObject(h8, "test_photon_eta")
	...
	n1_1 = TCanvas()
        ...
        #n1_1.SetLogy()
        h2_1.Draw("hist")
        n1_1.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_low_pT_softdrop.png")
        n1_1.Close()

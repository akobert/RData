...
def DataPro(sample, fname, cut_hist, percentage=20):
	...
	ofile = ROOT.TFile("/home/akobert/CMSSW_11_1_0_pre7/src/RData/NanoTool_UL_percentage/output/RData_" + fname + ".root", "RECREATE")
	ofile.cd()
...
#		u6.Scale(1.0/9.0)
	...
	print("Final passed: "+str(final/total_events * 100)+"%")

...
#	ROOT.ROOT.EnableImplicitMT()
	...
	h4_notrig = TH1F("h4_notrig", "Photon pT", 25, widebins)
        h4_OR_thin = TH1F("h4_OR_thin", "Photon pT", 500, 0, 500)
        h4_notrig_thin = TH1F("h4_notrig_thin", "Photon pT", 500, 0, 500)
#	h4_pt = TH1F("h4_pt", "Photon pT", 25, widebins)
	...
	for F in sample:
		...
		Rdf_notrig = Rdf_PreSel.Filter("abs(pEta)<1.44 && pCut >= 3 && HLT_Mu50 > 0 && pR9 >= .1")

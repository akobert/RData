...
if __name__ == "__main__":
	...
	files = [["/cms/xaastorage/NanoAOD/2018/JUNE19/VectorZPrimeGammaToQQGamma_M150_temp/", str(59.9 * 1509.0/476269.0)]]
	...
	ROOT.gInterpreter.ProcessLine("auto cutoff = "+str(cut_ID)+";")
        ...
        ddt_code =      '''
                        ...
                        '''
        region_code = "float a=100; float b=300; float c=145; float d=160;"
	...
	percentage = 20
	fname = "150GeV_CutBased"
	SamplePro(files, fname, cut_hist, percentage)	
	
	

	print("150 GeV_CutBased")

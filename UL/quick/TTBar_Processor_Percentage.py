...
#	h1 = TH1F("h1", "N2", 25, 0, .5)
	...
	h2_gen = TH1F("h2_gen", "GenJet Passing Softdrop Mass", 40, 0, 200)
	h5_gen = TH1F("h5_gen", "GenJet Passing Jet pT", 40, 0, 200)
...
#
		...
		p2.Add(q2)
	        ...
	        q2_gen = Rdf_Pass.Histo1D(("q2_gen", "GenJet Passing Softdrop Mass", 40, 0, 200), "Gen_jM", "weight")
	        q2_gen = q2_gen.Clone()
	        q2_gen.SetTitle("GenJet Passing Softdrop Mass")
	        q2_gen.SetXTitle("Softdrop Mass")
		h2_gen.Add(q2_gen)

	        q5_gen = Rdf_Pass.Histo1D(("q5_gen", "GenJet Passing Jet Pt", 40, 0, 2000), "Gen_Pt", "weight")
	        q5_gen = q5_gen.Clone()
	        q5_gen.SetTitle("GenJet Passing Jet Pt")
	        q5_gen.SetXTitle("Pt")
		q5_gen.Add(q5_gen)
		...
		j27.SetYTitle("Photon pT / Jet pT")
                ...
                j26_w = Rdf_Fail.Histo2D(("pt_soft_fail_wide3", "Failing Jet pT vs. Softdrop Mass", 14, widebins3, 40, 0, 200), "jPt", "jM", "weight")
                j26_w = j26_w.Clone()
                h26_w.Add(j26_w)
                ...
                j28_w = Rdf_Pass.Histo2D(("pt_soft_pass_wide3", "Passing Jet pT vs. Softdrop Mass", 14, widebins3, 40, 0, 200), "jPt", "jM", "weight")
                j28_w = j28_w.Clone()
                h28_w.Add(j28_w)

...
#	files = [["/cms/akobert/NanoToolOutput/EGamma_RunA_Test/branch_present", str(1.0), 1], ["/cms/akobert/NanoToolOutput/EGamma_RunA_Test/branch_missing", str(1.0), 2], ["/cms/akobert/NanoToolOutput/EGamma_RunB_Test/", str(1.0), 1], ["/cms/akobert/NanoToolOutput/EGamma_RunC_Test/", str(1.0), 1], ["/cms/akobert/NanoToolOutput/EGamma_RunD_Test/", str(1.0), 1]]

	files = [["/cms/akobert/NanoToolOutput/UL/EGamma_RunB/", str(1.0), 1], ["/cms/akobert/NanoToolOutput/UL/EGamma_RunC/", str(1.0), 1]]

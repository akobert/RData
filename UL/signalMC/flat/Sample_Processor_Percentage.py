...
def MakeHist(Chain, cut_hist, ofile, fname, weight):
	...
	c1.cd()
	h1.Draw()
	c1.SaveAs("./RData_"+fname+"_N2.png")
	c1.Close()
	...
	c2.cd()
	h2.Draw()
	c2.SaveAs("./RData_"+fname+"_pass_soft.png")
	c2.Close()
	print("Plot 2_2")
	...
	c2_2.cd()
	h2_2.Draw()
	c2_2.SaveAs("./RData_"+fname+"_soft.png")
	c2_2.Close()
	print("Plot 3")
	...
	c3.cd()
	h3.Draw()
	c3.SaveAs("./RData_"+fname+"_n2ddt.png")
	c3.Close()
	print("Plot 4")
	...
	c4.cd()
	h4.Draw()
	c4.SaveAs("./RData_"+fname+"_pass_photon_pt.png")
	c4.Close()
	print("Plot 5")
	...
	c5.cd()
	h5.Draw()
	c5.SaveAs("./RData_"+fname+"_pass_jet_pt.png")
	c5.Close()
	print("Plot 6")
	...
	c6.cd()
	h6.Draw()
	c6.SaveAs("./RData_"+fname+"_pass_jet_eta.png")
	c6.Close()
	print("Plot 7")
	...
	c7.cd()
	h7.Draw()
	c7.SaveAs("./RData_"+fname+"_pass_rho.png")
	c7.Close()
        ...
        c7_1.cd()
        h7_1.Draw()
        c7_1.SaveAs("./RData_"+fname+"_finerho.png")
        c7_1.Close()
	...
	c8.cd()
	h8.Draw()
	c8.SaveAs("./RData_"+fname+"_pass_photon_eta.png")
	c8.Close()
	print("Plot f2")
	...
	d2.cd()
	f2.Draw()
	d2.SaveAs("./RData_"+fname+"_fail_soft.png")
	d2.Close()
	print("Plot f4")
...
#	f4.Scale(1.0/9.0)
	...
	d4.cd()
	f4.Draw()
	d4.SaveAs("./RData_"+fname+"_fail_photon_pt.png")
	d4.Close()
	print("Plot f5")
...
#	f5.Scale(1.0/9.0)
	...
	d5.cd()
	f5.Draw()
	d5.SaveAs("./RData_"+fname+"_fail_jet_pt.png")
	d5.Close()
	print("Plot f6")
...
#	f6.Scale(1.0/9.0)
	...
	d6.cd()
	f6.Draw()
	d6.SaveAs("./RData_"+fname+"_fail_jet_eta.png")
	d6.Close()
	print("Plot f7")
...
#	f7.Scale(1.0/9.0)
	...
	d7.cd()
	f7.Draw()
	d7.SaveAs("./RData_"+fname+"_fail_rho.png")
	d7.Close()
	print("Plot f8")
...
#	f8.Scale(1.0/9.0)
	...
	d8.cd()
	f8.Draw()
	d8.SaveAs("./RData_"+fname+"_fail_photon_eta.png")
	d8.Close()
	...
	h11 = Rdf.Histo2D(("n2_n2ddt", "N2 vs. N2DDT", 25, 0, .5, 50, -.5, .5), "N2", "n2ddt", "total_weight")
        ...
        n1.cd()
        h11.Draw("COLZ")
        n1.SaveAs("./RData_"+fname+"_n2_n2ddt.png")
        n1.Close()
	...
	n2.cd()
	h12.Draw()
	n2.SaveAs("./RData_"+fname+"_N2.png")
	n2.Close()
	...
	n3.cd()
	h13.Draw()
	n3.SaveAs("./RData_"+fname+"_N2DDT.png")
	n3.Close()
	...
	h14 = Rdf.Histo2D(("n2_soft", "N2 vs. Softdrop Mass", 25, 0, .5, 40, 0, 200), "N2", "jM", "total_weight")
        ...
        n4.cd()
        h14.Draw("COLZ")
        n4.SaveAs("./RData_"+fname+"_n2_soft.png")
        n4.Close()
	...
	h15 = Rdf.Histo2D(("n2ddt_soft", "N2DDT vs. Softdrop Mass", 50, -.5, .5, 40, 0, 200), "n2ddt", "jM", "total_weight")
        ...
        n5.cd()
        h15.Draw("COLZ")
        n5.SaveAs("./RData_"+fname+"_n2ddt_soft.png")
        n5.Close()
	#ofile.WriteObject(TH1F(h3), "N2DDT")	
        ...
        n6.cd()
        h16.Draw("COLZ")
        n6.SaveAs("./RData_"+fname+"_jet_pt_soft_pass.png")
        n6.Close()
	...
	h16_w = Rdf_Pass.Histo2D(("pt_soft_pass_wide", "Passing Jet pT vs. Softdrop Mass", 8, widebins, 40, 0, 200), "jPt", "jM", "total_weight")
        ...
        n6_w.cd()
        h16_w.Draw("COLZ")
        n6_w.SaveAs("./RData_"+fname+"_jet_pt_soft_pass_wide.png")
        n6_w.Close()
        ...
        n6_1.cd()
        h16_1.Draw("COLZ")
        n6_1.SaveAs("./RData_"+fname+"_jet_pt_soft_total.png")
        n6_1.Close()
	...
	h16_1_w = Rdf.Histo2D(("pt_soft_total_wide", "Total Jet pT vs. Softdrop Mass", 8, widebins, 40, 0, 200), "jPt", "jM", "total_weight")
        ...
        n6_1_w.cd()
        h16_1_w.Draw("COLZ")
        n6_1_w.SaveAs("./RData_"+fname+"_jet_pt_soft.png")
        n6_1_w.Close()
	...
	h17 = Rdf_Fail.Histo2D(("pt_soft_fail", "Failing Jet pT vs. Softdrop Mass", 40, 0, 2000, 40, 0, 200), "jPt", "jM", "total_weight")
        ...
        n7.cd()
        h17.Draw("COLZ")
        n7.SaveAs("./RData_"+fname+"_jet_pt_soft.png")
        n7.Close()
	...
	h17_w = Rdf_Fail.Histo2D(("pt_soft_fail_wide", "Failing Jet pT vs. Softdrop Mass", 8, widebins, 40, 0, 200), "jPt", "jM", "total_weight")
        ...
        n7_w.cd()
        h17_w.Draw("COLZ")
        n7_w.SaveAs("./RData_"+fname+"_jet_pt_soft_fail_wide.png")
        n7_w.Close()
	...
	n26.cd()
        n26.SetLogz()
	h26.Draw("COLZ")
	n26.SaveAs("./RData_"+fname+"_pt_photon_jet.png")
	n26.Close()
	...
	n27 = TCanvas()
        ...
        n27.SetLogz()
        h27.Draw("COLZ")
        n27.SaveAs("./RData_"+fname+"_photon_jet_ratio_pt.png")
        n27.Close()

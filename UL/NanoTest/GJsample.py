...
if __name__ == "__main__":
	...
	GJets = [["/cms/xaastorage/NanoAOD/2018/JUNE19/NanoToolOutput/UL/GJets/100to200", str(59.9 * 8640000.0/10125438.0)], ["/cms/xaastorage/NanoAOD/2018/JUNE19/NanoToolOutput/UL/GJets/200to400", str(59.9 * 2183000.0/19755305.0)], ["/cms/xaastorage/NanoAOD/2018/JUNE19/NanoToolOutput/UL/GJets/400to600", str(59.9 * 260200.0/4786197.0)], ["/cms/xaastorage/NanoAOD/2018/JUNE19/NanoToolOutput/UL/GJets/600toInf", str(59.9 * 86589.0/4905665.0)]]

	cutfile = "./RData_Cutoffs_NanoTool.root"
	cf = TFile(cutfile)
	...
	ROOT.gInterpreter.ProcessLine("auto cutoff = "+str(cut_ID)+";")
        ...
        cflow_code =    '''
                        ...
                        bool PID(RVec<float> ppt, RVec<float> peta, RVec<bool> pID, int nPho)
                        {
                                for(int i=0; i<nPho; i++)
                                {
                                        if(abs(peta[i]) < 2.4 && ppt[i] > 110 && pID[i])
                                        {
                                                return true;
                                        }
                                }

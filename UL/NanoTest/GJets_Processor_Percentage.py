...
#		pass_sig_thin_pass_weight125_slice = 0
	...
	#	Rdf_PreSel = Rdf_noCut.Filter("(HLT_Photon110EB_TightID_TightIso > 0. || HLT_Photon175 > 0) && nPhoton > 0. && nselectedPatJetsAK8PFPuppi > 0. && selectedPatJetsAK8PFPuppi_msoftdrop_nom.size()>0")
		...
		#Rdf = Rdf.Define("jM", "selectedPatJetsAK8PFPuppi_msoftdrop_nom[jIndex]/(1-selectedPatJetsAK8PFPuppi_rawFactor[jIndex])")
...
#	pc1_1.cd()
#	p1_1.Draw("hist")
#	pc1_1.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_pass_soft_over.png")
#	pc1_1.Close()
        ...
        m0.SetLogy()
        h7_1.Draw("hist")
        m0.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_finerho.png")
        m0.Close()
...
#        n1.SetLogy()
        h2.Draw("hist")
        m1.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_softdrop.png")
        m1.Close()
	
	h2_1.SetTitle("Softdrop Mass pT<200")
        h2_1.SetXTitle("Softdrop Mass")

        m1_1 = TCanvas()
        m1_1.cd()
        h2_1.Draw("hist")
        m1_1.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_softdrop_low.png")
        m1_1.Close()
	...
	h2_2.SetTitle("Softdrop Mass pT>200")
        ...
        m1_2.cd()
        h2_2.Draw("hist")
        m1_2.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_softdrop_high.png")
        m1_2.Close()
	...
	m2 = TCanvas()
        ...
        m2.SetLogy()
        h4.Draw("hist")
        m2.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_pho_pt.png")
        m2.Close()
	...
	m3 = TCanvas()
        ...
        m3.SetLogy()
        h5.Draw("hist")
        m3.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_jet_pt.png")
        m3.Close()
	...
	m4 = TCanvas()
        ...
        m4.SetLogy()
        h6.Draw("hist")
        m4.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_jet_eta.png")
        m4.Close()
	...
	m5 = TCanvas()
        ...
        m5.SetLogy()
        h8.Draw("hist")
        m5.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_pho_eta.png")
        m5.Close()
	...
	h15_1.SetTitle("Softdrop Mass vs. N2DDT")
        ...
        n7.cd()
        h17.Draw("COLZ")
        n7.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_rho_soft_pass.png")
        n7.Close()
	...
	h18.SetTitle("Failing Rho vs. Softdrop Mass")
        ...
        n8.cd()
        h18.Draw("COLZ")
        n8.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_rho_soft_fail.png")
        n8.Close()
	...
	h21_w2.SetTitle("Passing Jet pT vs. Softdrop Mass")
        h21_w2.SetYTitle("Softdrop Mass")
        h21_w2.SetXTitle("Jet pT")
        ofile.WriteObject(h21_w2, "jet_pt_soft_pass_wide2")

        n11_w2 = TCanvas()
        n11_w2.cd()
        h21_w2.Draw("COLZ")
        n11_w2.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_jet_pt_soft_pass_wide2.png")
        n11_w2.Close()
	...
	h23_w2.SetTitle("Failing Jet pT vs. Softdrop Mass")
        h23_w2.SetYTitle("Softdrop Mass")
        h23_w2.SetXTitle("Jet pT")
        ofile.WriteObject(h23_w2, "jet_pt_soft_fail_wide2")

        n13_w2 = TCanvas()
        n13_w2.cd()
        h23_w2.Draw("COLZ")
        n13_w2.SaveAs("/home/akobert/CMSSW_11_1_0_pre7/src/plots/RData_"+fname+"_jet_pt_soft_fail_wide2.png")
        n13_w2.Close()
